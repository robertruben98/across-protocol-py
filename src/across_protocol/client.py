"""Synchronous client for the Across Protocol bridge API."""
...
class AcrossClient:
    ...
    The default base URL targets the public production API, which requires no
    API key for the quoting endpoints exposed here.

    Args:
        base_url: Base URL of the Across API. Defaults to the production host.
        timeout: Per-request timeout in seconds.
        client: An optional pre-configured :class:`httpx.Client`. When supplied,
            the caller owns its lifecycle and :meth:`close` will not close it.
    ...
    def __enter__(self) -> AcrossClient:
        return self
    ...
    def get_suggested_fees(
        ...
        *,
        ...
        Example:
            ...
            ...         amount=10_000_000,
            ...     )
            ...     print(quote.total_relay_fee.total)
        """
        ...
        return SuggestedFees.model_validate(self._get("/suggested-fees", params))
    ...
    def get_available_routes(
        ...
        *,
        ...
        data = self._get("/available-routes", params)
    ...
    def get_limits(
        ...
        *,
        ...
        return Limits.model_validate(self._get("/limits", params))
    ...
    def get_deposit_status(
        ...
        *,
        ...
        return DepositStatus.model_validate(self._get("/deposit/status", params))
    ...
    def wait_for_deposit(
        ...
        *,
        ...
        while True:
            status = self.get_deposit_status(
                origin_chain_id=origin_chain_id,
                deposit_id=deposit_id,
                deposit_tx_ref=deposit_tx_ref,
            )
